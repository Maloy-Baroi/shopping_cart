...
backtohome.addEventListener('click', () => {
    page_title.innerText = "Coffee List";
...
function addItemToCart(title, price, imageSrc) {
    ...
    cartRow.innerHTML = `
        <div class="cart-item cart-column">
            <img class="cart-item-image" src="${imageSrc}" width="100" height="100" alt="image op">
